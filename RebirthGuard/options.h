...
#define RG_OPT_REBIRTH_SYSTEM_MODULES				(RG_ENABLE & !RG_OPT_COMPAT_VMPROTECT)
#define RG_OPT_REBIRTH_ALL_MODULES					(RG_ENABLE & !RG_OPT_COMPAT_VMPROTECT)
#if __cplusplus >= 201703
#define RG_OPT_SET_PROCESS_POLICY					(RG_ENABLE & !RG_OPT_COMPAT_VMPROTECT & !RG_OPT_COMPAT_THEMIDA)	// EXE only
#endif
#define RG_OPT_ANTI_DLL_INJECTION					(RG_ENABLE | RG_ENABLE_KILL)
#define RG_OPT_ANTI_DEBUGGING						(RG_ENABLE | RG_ENABLE_KILL)
#define RG_OPT_THREAD_CHECK							(RG_ENABLE | RG_ENABLE_KILL)
#define RG_OPT_MEMORY_CHECK							(RG_ENABLE | RG_ENABLE_KILL | RG_ENABLE_DEALLOC)
